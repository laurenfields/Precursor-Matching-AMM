...
working_directory = r"E:/Everything/DesktopEverything/CrustaceanStudies/CHHStudies/FusionLumos/20220416/AMM/G"
MS2_path = r"E:/Everything/DesktopEverything/CrustaceanStudies/CHHStudies/FusionLumos/20220416/20220416_SG-CHH-Fraction-UnoptimizedMethod_NewLCgradient_1.ms2"
tissue_type = 'G'
trial_no = 1
...
new_list= []
final_lst = []
final_lst.append(['m/z', 'resolution', 'charge', 'intensity', 'MS2','scan_number','precursor_charge','empty'])
ms2_list = []
...
csv_path = working_directory + '\\' + tissue_type + trial_no + csv_suf
