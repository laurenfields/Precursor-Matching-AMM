...
final_dir =r"C:\Users\lawashburn\Documents\Nhu_Prescursor_Matching\20220502_distribution\20220504\Lauren_Results\precursor_matching" #path to directory for final, processed data
...
for b in precursor_charges:
        ...
        for c in precursor_target:
            ...
            if len(spectra_value_filtered_err) > 0:
                precursor_matches = precursor_matches.append(spectra_value_filtered_err)

precursor_matches = precursor_matches.drop(columns = ['empty','empty2'])

file_name = sample_name + '_precursor_matches.csv'
